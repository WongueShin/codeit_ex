...
class BinarySearchTree:
    ...
    def delete(self, data):
        ...
        if (node_to_delete.left_child and node_to_delete.right_child) is None:
        ...
        elif node_to_delete.right_child != None and node_to_delete.left_child == None:
        ...
        if node_to_delete.left_child != None and node_to_delete.right_child != None:
            #print(f'del_data = {node_to_delete.data}\nleft ={node_to_delete.left_child.data}\nright ={node_to_delete.right_child.data}')
